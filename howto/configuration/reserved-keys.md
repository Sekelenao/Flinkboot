...
| `-flinkboot-configuration-violations-log-size` | `FLINKBOOT_CONFIGURATION_VIOLATIONS_LOG_SIZE` | `10`                               | Maximum number of Bean Validation error messages displayed in logs before truncation.    |
