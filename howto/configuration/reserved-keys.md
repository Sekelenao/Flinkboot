...
| `--flinkboot-configuration-disable-validation` | `FLINKBOOT_CONFIGURATION_DISABLE_VALIDATION` | `false`                            | Bypasses Jakarta Bean Validation checks on deserialized configuration models.            |
| `-flinkboot-configuration-violations-log-size` | `FLINKBOOT_CONFIGURATION_VIOLATIONS_LOG_SIZE` | `10`                               | Strictly positive maximum number of Bean Validation error messages displayed before truncation. |
