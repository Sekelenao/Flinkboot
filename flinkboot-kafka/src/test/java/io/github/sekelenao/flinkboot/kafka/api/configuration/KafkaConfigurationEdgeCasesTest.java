...
public class KafkaConfigurationEdgeCasesTest {

    @Test
    @DisplayName("Should test equals, hashCode, and toString on all Kafka DTOs")
    void shouldTestEqualsHashCodeToStringOnKafkaDtos() {
        var part1 = new TopicPartitionOffsetConfiguration("topic-1", 0, 100L);
        var part2 = new TopicPartitionOffsetConfiguration("topic-1", 0, 100L);
        var part3 = new TopicPartitionOffsetConfiguration("topic-2", 1, 200L);
        ...
        var listConfig1 = new KafkaSourceTopicListConfiguration(List.of("localhost:9092"), "group1", List.of("topic1"), KafkaOffsetInitializer.EARLIEST, null, null, Map.of("k", "v"));
        var listConfig2 = new KafkaSourceTopicListConfiguration(List.of("localhost:9092"), "group1", List.of("topic1"), KafkaOffsetInitializer.EARLIEST, null, null, Map.of("k", "v"));
        var listConfig3 = new KafkaSourceTopicListConfiguration(List.of("localhost:9092"), "group2", List.of("topic2"), KafkaOffsetInitializer.TIMESTAMP, 10000L, null, null);
        ...
        var patternConfig1 = new KafkaSourceTopicPatternConfiguration(List.of("localhost:9092"), "group1", "^topic-.*$", KafkaOffsetInitializer.EARLIEST, null, null, Map.of("k", "v"));
        var patternConfig2 = new KafkaSourceTopicPatternConfiguration(List.of("localhost:9092"), "group1", "^topic-.*$", KafkaOffsetInitializer.EARLIEST, null, null, Map.of("k", "v"));
        var patternConfig3 = new KafkaSourceTopicPatternConfiguration(List.of("localhost:9092"), "group2", "^other-.*$", KafkaOffsetInitializer.TIMESTAMP, 10000L, null, null);
        ...
        var sinkConfig1 = new KafkaSinkConfiguration(List.of("localhost:9092"), "topic1", KafkaDeliveryGuarantee.AT_LEAST_ONCE, null, Map.of("k", "v"));
        var sinkConfig2 = new KafkaSinkConfiguration(List.of("localhost:9092"), "topic1", KafkaDeliveryGuarantee.AT_LEAST_ONCE, null, Map.of("k", "v"));
        var sinkConfig3 = new KafkaSinkConfiguration(List.of("localhost:9092"), "topic2", KafkaDeliveryGuarantee.EXACTLY_ONCE, "tx-prefix", null);
    ...
    void shouldTestGettersWithNullOrEmptyFields() {
        var nullSinkConfig = new KafkaSinkConfiguration(List.of("localhost:9092"), "topic", null, "", null);
        var nullListConfig = new KafkaSourceTopicListConfiguration(List.of("localhost:9092"), "group", List.of("topic"), KafkaOffsetInitializer.EARLIEST, null, null, null);
        var nullPatternConfig = new KafkaSourceTopicPatternConfiguration(List.of("localhost:9092"), "group", "^pattern$", KafkaOffsetInitializer.EARLIEST, null, null, null);
